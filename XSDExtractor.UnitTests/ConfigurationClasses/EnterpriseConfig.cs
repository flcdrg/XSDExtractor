...
namespace JFDI.Utils.XSDExtractor.UnitTests.ConfigurationClasses {
  ...
  /// <summary>
  /// This class is here to support the <see cref="JFDI.Utils.XSDExtractor.UnitTests.Bugs.DuplicateCollectionTypes"/> unit tests.
  /// </summary>
  /// <remarks>
  ...
  [ConfigurationCollection(typeof(DeparmentConfig), AddItemName = "Person", CollectionType = ConfigurationElementCollectionType.BasicMap)]
